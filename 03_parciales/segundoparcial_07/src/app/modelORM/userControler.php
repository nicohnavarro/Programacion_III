...
class userControler implements IApiControler 
{
  ...
  public function CargarUno($request, $response, $args) {
    ...
    {
      if($datos["legajo"] > 1 && $datos["legajo"] <= 1000)
      {
  ...
  public function IngresoUsuario($request, $response, $args)
  {
    ...
    if($ingresoUsuario == null)
    {
      ...
      $newResponse = $response->withJson("Ingresó", 200); 
    }
    else
    {
      $newResponse = $response->withJson("Ya está ingresado", 200);
    }
  ...
  public function EgresoUsuario($request, $response, $args)
  {
    ...
    if($ingresoUsuario != null)
    {
      ...
      $newResponse = $response->withJson("Egreso", 200); 
    }
    else
    {
      $newResponse = $response->withJson("No está ingresado", 200);
    }
  ...
  public function MostrarIngreso($request, $response, $args)
  {
    ...
    {
      $datos = historial_ingreso::where('id_usuario', $usuario->legajo)->get();
